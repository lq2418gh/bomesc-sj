 ...
 */
@Entity
@Table(name="b_pi_data_track_supp")
public class PiDataTrackSupp extends BusinessEntity{
	...
	@Column(nullable=true,length=200)
	private String ident_code;//识别编号
	...
	public void setInsultation_equivalent_length(BigDecimal insultation_equivalent_length) {
